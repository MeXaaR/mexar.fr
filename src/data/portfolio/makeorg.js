export const makeOrgMigration = {
    ...
    challenges: [
        {
            challenge: "Compréhension et transformation d'un code non documenté",
            solution: "Analyse approfondie du code existant et refactoring pour intégrer TypeScript, assurant une codebase typée et maintenable.",
        },
        {
            challenge: "Réorganisation de deux projets en un monorepo",
            solution: "Utilisation de Yarn et Lerna pour fusionner les projets en un monorepo, facilitant la gestion et la cohérence du développement.",
        },
        {
            challenge: "Maintenir la qualité du code durant la migration",
            solution: "Mise en place de tests automatisés et de revues de code régulières pour garantir la qualité et la fiabilité de la nouvelle codebase.",
        },
    ],
};
